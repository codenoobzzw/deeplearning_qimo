...
- [x] refs.bib exists
- [x] outputs/weights/hw3_weights.zip exists
- [x] run_manifest.md exists
- [x] no obvious API key/token in text files

This checklist is generated from actual file existence checks; unchecked items were not fabricated as complete.
